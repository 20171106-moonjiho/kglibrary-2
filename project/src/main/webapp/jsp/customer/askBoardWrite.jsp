...
<div align="center" style="margin-top: 100px;">
	<form action="askWriteProc" method='post' enctype="multipart/form-data">
			<div class="card">
			<div class="card-write">
		<table>
			<caption>
				<font size="5" align="center"><b> 1:1 문의 등록</b></font><br><br>
			</caption>
			<tr>
			...
			<div class="btn-w">
				<td colspan="2" align="center">
					...
					<input type="button" value="목록"	 onclick="location.href='askForm'">
				</td>
				</div>
				</div>
			</tr>
