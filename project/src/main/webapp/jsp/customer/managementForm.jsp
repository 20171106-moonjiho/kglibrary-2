...
<div style="width: 1200px; margin: 0 auto; margin-top: 100px;">
	...
	<form action="managementForm">
		<span> ▷ 총 ${count }개의 게시물이 있습니다. </span> <span class="right"> <select class="selectBox" name="select">
			...
			<table style="margin-top: 30px;">
				...
				<c:forEach var="board" items="${ boards}">
					<tr>
						...
						<td class="left"
							onclick="location.href='managementBoardContent?no=${board.no }'">
							${board.title }</td>
	...
	<c:choose>
		...
		<span class="right">
			<button type="button"
					onclick="location.href='managementBoardWrite'" class="submit_button">글쓰기</button>
		</span>
		</c:when>
	</c:choose>
