...
<div align="center" style="margin-top: 100px;">
	...
	<form action="managementWriteProc" method='post' enctype="multipart/form-data">
			<div class="card">
			<div class="card-write">
		<table>

			<caption>
				<font size="5"><b>공지 사항 등록</b></font><br><br>
			</caption>
			<tr>	
			...
			<div class="btn-w">
				<td colspan="2" align="center">
					...
					<input type="button" value="목록"	 onclick="location.href='managementForm'">
				</td>
			</div>
			</div>
			</tr>
