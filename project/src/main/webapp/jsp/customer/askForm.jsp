...
<div style="width: 1200px; margin: 0 auto; margin-top: 100px;">
	...
	<form action="askForm">
		<span> ▷ 총 ${count }개의 게시물이 있습니다. </span> <span class="right"> <select
			class="selectBox" name="select">
			...
			<table style="margin-top: 30px;">
				...
				<c:forEach var="board" items="${ boards}">
					<tr>
						...
						<td class="left" onclick="location.href='askBoardContent?no=${board.no }'">
							${board.title } <c:choose>
								<c:when
									test="${board.replycount eq 'exgistreply' and sessionScope.id ne 'admin'}">
									<img src="/img/new.jpg" width="30" hight="25">
								</c:when>
								<c:otherwise>
	...
	<span class="right">
		<button type="button" onclick="location.href='askBoardWrite'"
