...
<script>
	function deleteCheck(){
		...
		if(result == true){
			location.href="managementBoardDeleteProc?no=${board.no}"
		}
	}
</script>
<style>
...
<div class="main_box">
	...
	<div class="button_bar">
		<button type="button" onclick="location.href='managementForm'">목록</button>
		<c:choose>
			<c:when test="${sessionScope.id eq 'admin'}">
				<button type="button" onclick="location.href='managementBoardModify?no=${board.no }'">수정</button>
