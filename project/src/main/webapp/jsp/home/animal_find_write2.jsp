...
.find_write_table tr{border: dotted 1px #dedede;}
</style>
		...
		<table class="find_write_table">
			...
			<tr>
				...
				<td width="300px" align="left" bgcolor="#ffffff">				                                    
					 ...
					 <input type="text" name="areatext" maxlength="25" size="17" style="background-color:rgb(248,248,248); border-width:1px; border-color:rgb(204,204,204); border-style:solid;" value="">
				 </td>
			</tr>
			<tr>
				 <th>반려동물</th>
			...
			<th>반려동물 나이</th>
				<td>
					<input style="width: 100%;" name="age">
				</td>
			</tr>
			<tr>
			<th>잃어버린 날짜</th>
				<td>
					<input style="width: 100%;" name="day"> 
			...
			<tr>
				<th>전화번호</th>
				<td>
					<input style="width: 100%;" name="tel">
			...
			<tr>
				<th>사례금</th>
				<td>
					<input style="width: 100%;" name="money" value="0"> 
