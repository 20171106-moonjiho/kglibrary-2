...
<div style="margin: 0 auto; margin-top:100px;">
	<form action="animal_find_ModifyProc" method='post' id="f" enctype="multipart/form-data">
		...
		<div class="card">
			...
			<div class="area">
				<span class="subject_title">실종 지역</span>
				 <select class="selectBox" name="area" style="font-size:10pt;">
					 ...
					 <input type="text" name="areatext" maxlength="25" size="17" style=" width: 510px; background-color:rgb(248,248,248); border-width:1px; border-color:rgb(204,204,204); border-style:solid;" value="${board.areatext }">
			</div>	
				
			<div class="animalinfo">
				<span class="subject_title">반려동물 정보</span>
				...
				<input type="text" name="name" placeholder="반려동물의 이름" value="${board.name }">
				<input type="text" name="age" placeholder="반려동물의 나이" value="${board.age }">
			</div>
				
			<div class="day">
					<span class="subject_title">실종일</span>
					 <input type="text" name="day" placeholder="실종일을 입력하세요." value="${board.day }">
					<span style="margin-left: 10px; font-size:13px;">※기입 예) 2023-10-23</span>
			</div>
			<div class="myinfo">
					<span class="subject_title">전화번호</span>
					<input type="text" name="tel" placeholder="전화 번호를 입력해 주세요." value="${board.tel }">
					<span style="margin-left: 10px; font-size:13px;">※기입 예) 010-1234-1234</span>
			</div>
				
			<div class="cate">
				<span class="subject_title">긴급 여부</span> 
				<select class="selectBox" name="cate" style="font-size:10pt;">
							<option value="일반">일반</option>
							<option value="긴급">긴급</option>
				</select>
				<span class="subject_title">사례금</span>
				<input type="text" name="money" value="0" value="${board.money }">
				<span style="color:red; margin-left: 10px; font-size:13px;">사례금은 10만원이상 넘을 수 없습니다.</span>
			</div>
			...
			<div class="msg">
				...
				<input type="file" name="upfile">${board.image } <span style="color: lightcoral">해당 사진이 썸네일로 등록됩니다.</span><br> 
				<input type="file" name="upfile2">${board.image2 }<br>
				<input type="file" name="upfile3">${board.image3 }
			</div>
		</div>
			<div class="btn-w">
