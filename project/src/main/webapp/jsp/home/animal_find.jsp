...
<div class="sub_top_img" style="width: 100%; position: relative">
	<div><img src="/img/83a15506bd165.jpg"></div>
		<div class="sub_top_in_text">
		<p style="color: #fff">실종 반려동물 게시판</p>
		</div>
	</div>
...
<select class="selectBox" name="area" style="font-size:10pt;">
	...
	<table class="animal_lost">
		...
		<tr>
			<th>
				<a href="animal_find_Content?no=${board.no }"><div class="table_box">
				<c:choose>
					...
					line-height:18px; text-overflow:ellipsis; white-space: nowrap; overflow: hidden; display: block; line-height: 35px" align="left">
						...
						<td style="font:13px '돋움'; color:#999999; letter-spacing:-1px;">${board.id }</td>
							...
							<td style="font:13px '돋움'; color:#999999; letter-spacing:-1px;">${board.cate }</td>
							<td style="font:13px '돋움'; color:#d3d3d3; padding:0 5px;">|</td>
							<td style="font:13px '돋움'; color:#999999; letter-spacing:-1px;">${board.animal_group }</td>
							<td style="font:13px '돋움'; color:#d3d3d3; padding:0 5px;">|</td>
							<td style="font:13px '돋움'; color:#d10000;">사례금 : ${board.money }</td>
						</tr>
					</table>
				</div></a>
			</th>
		...
		<div style="width:85px; margin: 0 auto;"><button class="more_button" type="button" onclick="location.href='animal_find_write'">글쓰기</button></div>
		<table class="animal_lost">
