...
<title>index</title>
    ...
    function combat(checkbox) {
        ...
        check1.checked = checkbox.checked;
...
<body>
	...
	<form action="regist" method="post" id="f">
		<input type="hidden" id ="allcheck" name ="allcheck" value="ok">
		<div align="center" style="margin-bottom:30px;">
					<label class = "form-check-label ">
						<input type="checkbox" class ="form-control" name="check_all" id="check_all" onclick="combat(this)">
												<span>이용약관, 개인정보 수집 및 이용에 모두 동의합니다.</span><br> <!-- 전부 체크-->
					</label>			
		</div>
		<div align="center" style="margin-bottom:20px;">
					<label >			
						<input type="checkbox" class="chk" name="agree" id="check1" value=1 >
						<span>이용약관 동의<em class="alert">(필수)</em></span><br>
					</label>
...
- 기타 관계법령에 위배된다고 판단되는 경우4. 사이트 및 운영자는 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 게시중단(전송중단)할 수 있으며, 게시중단 요청자와 게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련기관의 결정 등이 이루어져 사이트에 접수된 경우 이에 따릅니다.<br>
<br>
제13조 게시물의 보관<br>
<br>
...
이 약관은 &lt;사이트 개설일&gt; 부터 시행합니다.					</div>
		...
		<div class="input-block" align="center">
					<label>
						<input type="checkbox" class="chk" name="agree" id="check2" value="2">
						개인정보 수집 및 이용 동의<em class="alert">(필수)</em>
					</label>
			
			<div class="input-block" align="center">
					<div tabindex="0" class="form-control" style="width : 800px; height: 150px; border:1px solid #dfe0df; margin-top: 10px; border-radius: 4px; padding: 12px 14px; overflow-y: auto; background:#fff; color:#000;">
...
-보존기간 : 3개월<br>
<br>
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.					</div>
				</div>
			</div>

		
		        <div class="input-block" style="margin-bottom: 20px; margin-top: 20px;" align="center">
                    <label class="form-label">
                        <input type="checkbox" class="chk" name="agree" id="check3" value="3">
                        <span>만 14세 이상입니다. <span class="body_font_color_70"><em class="alert">(필수)</em></span></span>
                    </label>
                </div>
				...
				<input type="button" value="회원가입" onclick="agreeCheck()"><br>
				</div>
