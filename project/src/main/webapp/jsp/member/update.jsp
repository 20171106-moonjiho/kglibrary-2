...
<div align="center" style = "margin-top:100px;">
	...
	<tr><td>
	<form action="updateProc" method="post" id="f"  align="left" style="margin-left:36%">
		<!--  <input type="hidden" id="id" name="id" value="${member.id}">-->
	
		<input type="text" value="${member.id}" name="id" id="id" readonly> <br>
		...
		<input type="text" name="tel" id = "tel" value="${member.tel }"><br>
